...
const viewCount = computed(() => blogStore.getViewCount(props.post.slug))
      ...
      <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700/50 flex items-center justify-between">
        ...
        <div class="flex items-center space-x-3 text-xs text-gray-500 dark:text-gray-400">
          <span class="flex items-center">
            <Icon icon="lucide:eye" class="w-3.5 h-3.5 mr-1 text-[#7CB342]" />
            <span class="inline-block min-w-[1.5em] text-center">{{ viewCount || '--' }}</span><span class="ml-1">views</span>
          </span>
        </div>
      </div>
